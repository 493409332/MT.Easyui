...
namespace Complex.Repository
{
        ...
        where TEntity :Complex.Entity.EntityBase 
    {
        ...
        public int Insert<TEntity1>(TEntity1 entity) where TEntity1 : Complex.Entity.EntityBase 
        {
        ...
        public int Insert<TEntity1>(IEnumerable<TEntity1> entities) where TEntity1 : Complex.Entity.EntityBase 
        {
        ...
        public IQueryable<TEntity1> SearchFor<TEntity1>(Expression<Func<TEntity1, bool>> predicate) where TEntity1 : Complex.Entity.EntityBase 
        {
        ...
        public IQueryable<TEntity1> GetAllNoCache<TEntity1>() where TEntity1  :Complex.Entity.EntityBase 
        {
        ...
        public IQueryable<TEntity1> GetAll<TEntity1>() where TEntity1  :Complex.Entity.EntityBase 
        {
        ...
        //key删除
        public int DeleteByKey<TEntity1>(object id) where TEntity1  :Complex.Entity.EntityBase 
        {
            ///删除操作实现 
        ...
        public TEntity1 GetByKey<TEntity1>(object key) where TEntity1  :Complex.Entity.EntityBase 
        {
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        public int Update<TEntity1>(TEntity1 entities) where TEntity1  :Complex.Entity.EntityBase 
        {
            ...
            catch ( InvalidOperationException e )
            {
                ...
                //    throw e;
                //}
                TEntity1 oldEntity = dbSet.Find(entities.ID);
                EF.Entry(oldEntity).CurrentValues.SetValues(entities);
        ...
        /// <param name="page_size"></param>
        /// <returns></returns>
        public List<TEntity1> SearchSqLFor_PageGeneric<TEntity1>(string predicate, int page, int page_size, string order, string asc, out int total) where TEntity1  :Complex.Entity.EntityBase 
        {
            string Sql = string.Empty;
            string SqlCount = string.Empty;
            if ( EF.Database.Connection.ToString().StartsWith("System.Data.SqlClient") )
        ...
        public int Update<TEntity1>(object Id, TEntity1 entities) where TEntity1  :Complex.Entity.EntityBase 
        {
